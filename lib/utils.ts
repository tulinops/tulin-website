...
export const getThemeTokens = (mode: ThemeMode) => {
  ...
  return {
    ...
    textMuted: isDark ? "rgba(255,255,255,0.85)" : "rgba(0,0,0,0.75)",
    textFaint: isDark ? "rgba(255,255,255,0.7)" : "rgba(0,0,0,0.6)",
    textGhost: isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.35)",
